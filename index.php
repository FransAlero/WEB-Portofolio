...
// Query untuk mengambil data dari tabel 'profile'
...
<body>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 hero-content" data-aos="fade-right">
                        ...
                        <h2 class="animated-text"><?php echo htmlspecialchars($description); ?></h2>
                        <p class="mt-3">
    ...
    <footer>
        <div class="container">
            <p>&copy; 2024 <?php echo htmlspecialchars($name); ?>. Hak Cipta Dilindungi.</p>
            <div>
